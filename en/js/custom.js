...
　 }
    ...
    $contactForm.validate({
        ...
        messages: {
            ...
            email: {
                required    : "Indique o seu endereço de e-mail."
            },
            message: {
    ...
    $contactForm.submit(function(){
        var $success      = '<strong>Sucesso!</strong> Sua mensagem foi enviada.';
	    var $error      = '<strong>Erro!</strong> Sua mensagem não foi enviada - tente novamente mais tarde ...';
      	var response;
